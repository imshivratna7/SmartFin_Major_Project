...
// const RecentTransactions = ({month,year}) => {
//   console.log(month);
//   console.log(year);
      ...
      try {
        if (user && month && year) {
          ...
          const filteredTransactions = data.filter((transaction) => {
            const transactionDate = new Date(transaction.date); // Ensure `date` is in ISO format
            return (
              transactionDate.getMonth() + 1 === month && // getMonth() is zero-indexed
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-white p-6 rounded-lg shadow border border-black border-solid">
        ...
        {incomeTransactions?.length > 0 ? (
          ...
          <p className="text-gray-500">No recent income transactions for this period.</p>
        )}
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow border border-black border-solid">
        ...
        {expenseTransactions?.length > 0 ? (
          ...
          <p className="text-gray-500">No recent expense transactions for this period.</p>
        )}
      </div>
    </div>
  );
